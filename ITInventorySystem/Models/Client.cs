...
public class Client
{
    ...
    [Required] [StringLength(14)] public string IdDoc { get; set; } // CPF/CNPJ
    ...
    [JsonIgnore] public ICollection<WorkOrder> WorkOrders { get; set; } // Um cliente pode ter várias ordens de serviço
